...
namespace KoloryWPF
{
    ...
    public class SkladoweRGBToSolidColorBrushConverter : IMultiValueConverter
    {
        ...
        public object[] ConvertBack(object value, Type[] tarfetTypes, object parameter, System.Globalization.CultureInfo culture)
        {
    ...
    public class SkladoweRGBDoubleToSolidColorBruchConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
